...
public class CountryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null) {
            ...
            viewItem.textViewNationName = convertView.findViewById(R.id.txtNameQG);
            viewItem.textViewPopulation = convertView.findViewById(R.id.txtPopulation);
            viewItem.imageViewFlag = convertView.findViewById(R.id.imageFlags);
